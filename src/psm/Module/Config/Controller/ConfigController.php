	...
	protected function getLabels() {
		return array(
			...
			'label_sms_gateway_smsgw' => psm_get_lang('config', 'sms_gateway_smsgw'),
                        'label_sms_gateway_thsms' => psm_get_lang('config', 'sms_gateway_thsms'),
			...
			'label_log_retention_days' => psm_get_lang('config', 'log_retention_days'),
                        'label_line_notify' => psm_get_lang('config', 'line_notify'),
                        'label_line_token' => psm_get_lang('config', 'line_token'),
                        'label_line_enable' => psm_get_lang('config', 'line_enable'),
		);
	}
}