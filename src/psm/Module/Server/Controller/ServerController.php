		...
		if(!empty($edit_server)) {
			...
			$tpl_data = array_merge($tpl_data, array(
				...
				'edit_pushover_selected_' . $edit_server['pushover'] => 'selected="selected"',
                            /////////////// LINE SETTING ////////////
                                'edit_line_selected_' . $edit_server['line'] => 'selected="selected"',
			));
		}

		$notifications = array('email', 'sms', 'pushover','line');
	...
	protected function executeSave() {
		...
		$clean = array(
			...
			'pushover' => in_array($_POST['pushover'], array('yes', 'no')) ? $_POST['pushover'] : 'no',
                        ///////////// LINE SETTING /////////////
                        'line' => in_array($_POST['line'], array('yes', 'no')) ? $_POST['line'] : 'no',
		);
	...
	protected function getLabels() {
		return array(
			...
			'label_add_new' => psm_get_lang('system', 'add_new'),
                        ////// LINE SETTING ////////////
                        'label_line' => psm_get_lang('config', 'line'),
		);
	}
